  ...
  <table class="n23">
    ...
    <tr>
      ...
      <td><c:if test="${!productList.firstPage}">
          <a href="/shop/viewProductList2.do?page=previous"><font color="white"><B>&lt;&lt;
                Prev</B></font></a>
        </c:if> <c:if test="${!productList.lastPage}">
          <a href="/shop/viewProductList2.do?page=next"><font color="white"><B>Next
                &gt;&gt;</B></font></a>
        </c:if></td>
    </tr>
  </table>
   <a href="/shop/viewProductList2.do?page=previous">
</div>
